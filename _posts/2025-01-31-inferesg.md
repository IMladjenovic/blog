---
title: InferESG - Using AI to detect corporate greenwashing
...
This challenge was created by FinTech Scotland’s Financial Regulation Innovation Lab who selected our pitch to build [InferESG](https://github.com/ScottLogic/InferESG) - a multi-agent service for analysing sustainability reports, flagging potential greenwashing and answering ESG questions.

> **Multi-Agent Service:** A service containing multiple agents where each agent is specialised to solve a specific task using an LLM.
